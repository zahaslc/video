...
<body class="w100">
			...
			<div class="proflle_tab_body">
				<div class="proflle_tab_workplace clearfix">
					...
					<div class="profile_ifo_area">
						...
						<form action="updateUser" name="form">

							<div class="form_group">
								<span class="dd">昵 称：</span> <input name="nickname" id="nickname" type="text"
									value="${user.nickname }">
							...
							<div class="form_group">
								...
								<!-- 1990-10-04 -->
								<input name="birthday" id="birthday" type="text" value="${user.birthday }">
							</div>
							<div class="form_group">
	...
	<script src="http://localhost:8080/video/static/z/gVerify.js"></script>
