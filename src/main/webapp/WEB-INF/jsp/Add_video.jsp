...
<body>
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form action="addVideo.do" id="infoForm" class="form-horizontal"
			method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" id="detall" name="detall" rows="3"></textarea>
				</div>
			</div>
